...
private[sql] object ArrowUtils {
  ...
  def toArrowType(dt: DataType, timeZoneId: String, largeVarTypes: Boolean
      ): ArrowType = dt match {
  ...
  def toArrowSchema(schema: StructType, timeZoneId: String, largeVarTypes: Boolean
      ): Schema = {
