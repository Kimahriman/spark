...
class ArrowColumnVectorSuite extends SparkFunSuite {
  ...
  test("boolean") {
    ...
    val vector = ArrowUtils.toArrowField("boolean", BooleanType, nullable = true, null, false)
  ...
  test("byte") {
    ...
    val vector = ArrowUtils.toArrowField("byte", ByteType, nullable = true, null, false)
  ...
  test("short") {
    ...
    val vector = ArrowUtils.toArrowField("short", ShortType, nullable = true, null, false)
  ...
  test("int") {
    ...
    val vector = ArrowUtils.toArrowField("int", IntegerType, nullable = true, null, false)
  ...
  test("long") {
    ...
    val vector = ArrowUtils.toArrowField("long", LongType, nullable = true, null, false)
  ...
  test("float") {
    ...
    val vector = ArrowUtils.toArrowField("float", FloatType, nullable = true, null, false)
  ...
  test("double") {
    ...
    val vector = ArrowUtils.toArrowField("double", DoubleType, nullable = true, null, false)
  ...
  test("string") {
    ...
    val vector = ArrowUtils.toArrowField("string", StringType, nullable = true, null, false)
  ...
  test("array") {
    ...
    val vector = ArrowUtils.toArrowField("array", ArrayType(IntegerType), nullable = true, null,
      false).createVector(allocator).asInstanceOf[ListVector]
    vector.allocateNew()
  ...
  test("non nullable struct") {
    ...
    val vector = ArrowUtils.toArrowField("struct", schema, nullable = false, null, false)
  ...
  test("struct") {
    val allocator = ArrowUtils.rootAllocator.newChildAllocator("struct", 0, Long.MaxValue)
    val schema = new StructType().add("int", IntegerType).add("long", LongType)
    val vector = ArrowUtils.toArrowField("struct", schema, nullable = true, null, false)
      .createVector(allocator).asInstanceOf[StructVector]
    vector.allocateNew()
    val intVector = vector.getChildByOrdinal(0).asInstanceOf[IntVector]
    val longVector = vector.getChildByOrdinal(1).asInstanceOf[BigIntVector]
