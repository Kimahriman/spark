...
import sys
import time
from inspect import currentframe, getframeinfo, getfullargspec, isgeneratorfunction
import importlib
import json
...
def read_single_udf(pickleSer, infile, eval_type, runner_conf, udf_index):
    ...
    if eval_type == PythonEvalType.SQL_SCALAR_PANDAS_UDF:
        ...
        argspec = getfullargspec(chained_func)  # signature was lost when wrapping it
        is_generator = isgeneratorfunction(chained_func)
        return arg_offsets, wrap_grouped_map_arrow_udf(
        ...
        argspec = getfullargspec(chained_func)  # signature was lost when wrapping it
        is_generator = isgeneratorfunction(chained_func)
        return arg_offsets, wrap_cogrouped_map_arrow_udf(
            func, return_type, argspec, is_generator, runner_conf
        )
